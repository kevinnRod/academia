        ...
        <div class="col-sm-12">
            <div class="card border-primary shadow-sm">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <form action="{{ route('notaExamen.index') }}" method="GET">
                        ...
                        <tbody>
                            @foreach ($examenes as $examen)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('notaExamen.edit', $examen->idexamen) }}" class="btn btn-sm btn-primary">Editar</a>
                                        ...
                                        <a href="{{ route('grafico.circular', $examen->idexamen) }}" class="btn btn-sm btn-success" target="_blank">Ver Gráfico Circular</a>

                                        <form action="{{ route('notaExamen.confirmar', $examen->idexamen) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('GET')
