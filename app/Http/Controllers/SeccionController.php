...
class SeccionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('seccion.index',compact('secciones', 'periodo'));
    }
    ...
    public function create($idperiodo)
    {
        ...
        $grados = Grado::all();
        return view('seccion.create', compact('grados','periodo', 'nivelEscolar'));
    }
    ...
    public function store($idperiodo, Request $request)
    {
        ...
        $seccion->save();
        return redirect()->route('seccion.index', $idperiodo)->with('datos','Nueva sección creada...!');
    }
    ...
    public function edit(string $id)
    {
        ...
        $grados = Grado::all();
        $nivelEscolar = Nivel::all();
        return view('seccion.edit', compact('seccion', 'grados', 'nivelEscolar'));
    }
    ...
    public function update(Request $request, string $idA, string $idS)
    {
        ...
        $seccion->save();
        return redirect()->route('seccion.index', $seccion->idperiodo)->with('datos','Nueva sección creada...!');
    }
    ...
    public function destroy(string $idS)
    {
        ...
        return redirect()->route('seccion.index', $seccion->idperiodo)->with('datos','Registro Eliminado...!');
    }

    public function cancelar($idAnyo)
    {
        return redirect()->route('seccion.index', $idAnyo)->with('datos','Acción Cancelada ..!');
    }
}
